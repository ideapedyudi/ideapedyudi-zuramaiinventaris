...
<body>
  <div class="container" style="margin-top: 30px;">
    <a href="../index.php" class="nav-link btn btn-success mb-2" style="width: 80px;height: 40px;border-bottom-right-radius: 15px;background-color: #1cc88a;"><i class="fas fa-arrow-left"></i></a>
        ...
        <div class="card-body">
          ...
          <div class="col-lg-6 bg-white float-right" style="margin-top: 40px;">
            <form class="mt-n4" method="post" autocomplete="off">
              ...
              <input class="form-control btn btn-primary text-white" type="submit" name="login" value="Login Anggota" style="border-radius: 10px;">
            </form>
          </div>
